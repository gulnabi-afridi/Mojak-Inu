...
function Contact() {
  return (
    <ComponentWrapper style="py-8">
      <div className="w-full min-h-screen flex flex-col gap-4 md:gap-10 justify-center items-center">
...
const ContactSocial = [
  {
    path: "#",
    icon: <FaTelegramPlane className="text-[30px] md:text-[56px] text-white-main" />,
  },
  {
    path: "#",
    icon: <AiOutlineTwitter className="text-[30px] md:text-[56px] text-white-main" />,
  },
  {
    path: "#",
