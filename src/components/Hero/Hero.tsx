...
function Hero() {
  return (
    <ComponentWrapper style="py-8 lg:py-0">
      <div id="home" className="w-full min-h-[calc(100vh-150px)] flex justify-center items-center">
        <div className="w-full h-full xl:w-[90%] grid grid-cols-1 lg:grid-cols-[1fr,1fr] lg:gap-0 gap-5">
          {/* ===> left portion */}
          <div className="w-full flex flex-col gap-3 md:gap-6 justify-center items-start">
            <p className="w-full capitalize text-[30px] md:text-[56px] lg:text-left text-center font-carter font-semibold text-white-main italic">
              mojak inu
            </p>
            ...
            {/* ===> social links */}
            <div className="w-full flex flex-wrap justify-center lg:justify-start items-center gap-8">
          ...
          <div className="w-full col-span-1 lg:col-span-3 flex flex-wrap gap-4 justify-center lg:justify-start items-center">
            {/* 1 button */}
            <div className="w-[240px] h-[58px] flex justify-center hover:bg-white-main/20 items-center border-[2px] border-white-main rounded-[30px]">
...
const SocialLinks = [
  {
    path: "",
    icon: <AiOutlineTwitter className="text-[30px] md:text-[50px] text-white-main" />,
  },
  {
    path: "",
    icon: <FaTelegramPlane className="text-[30px] md:text-[50px] text-white-main" />,
  },
  {
    path: "",
    icon: "/assets/social/2.webp",
  },
  {
    path: "",
